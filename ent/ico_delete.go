...
func (id *IcoDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(ico.Table, sqlgraph.NewFieldSpec(ico.FieldID, field.TypeString))
...
func (ido *IcoDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{ico.Label}
	default:
		return nil
	}
}
